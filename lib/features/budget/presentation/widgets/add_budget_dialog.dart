...
class AddBudgetResult {
  final String name;
  final double limitAmount;
  final IconData icon;
  final String? preferredIncomeSourceId;

  const AddBudgetResult({
    required this.name,
...
class AddBudgetDialog extends StatefulWidget {
  ...
  const AddBudgetDialog({super.key, required this.incomeSources});
...
class _AddBudgetDialogState extends State<AddBudgetDialog> {
  ...
  String? _selectedSourceId; // null = tự động
      ...
      child: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Text('Thêm quỹ chi tiêu', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: _selectedSourceId == null ? AppColors.primary : Colors.grey.shade200,
                        width: _selectedSourceId == null ? 1.5 : 1,
                      ),
                    ),
                    child: Row(
                      children: [
                        ...
                        Text(
                          'Tự động (nguồn có số dư cao nhất)',
                          style: TextStyle(
                            fontSize: 12,
                            color: _selectedSourceId == null ? AppColors.primary : AppColors.textSecondary,
                            fontWeight: _selectedSourceId == null ? FontWeight.w600 : FontWeight.normal,
                          ),
                        ),
                        const Spacer(),
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(8),
                        border: Border.all(
                          color: selected ? AppColors.income : Colors.grey.shade200,
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            'Còn: ${AppDateUtils.formatCurrency(source.remainingAmount > 0 ? source.remainingAmount : 0)}',
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      if (name.isNotEmpty && limit > 0) {
                        Navigator.pop(context, AddBudgetResult(
                          name: name,
                          limitAmount: limit,
                          icon: _selectedIcon,
